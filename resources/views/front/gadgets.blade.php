						...
						<div class="w-full flex flex-col gap-1">
							...
							<div class="flex items-center justify-between">
								...
								<div class="flex items-center w-fit gap-[2px]">
									...
									<p class="text-sm leading-[21px]"><span class="font-semibold">{{number_format($product->testimonials->avg('rating'))}}/5</span> <span
											class="text-[#6E6E70]">({{$product->testimonials->count()}})</span></p>
								</div>
							</div>
						</div>
					</div>
